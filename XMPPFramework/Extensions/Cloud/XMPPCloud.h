...
- (void)requestCloudListFolderWithParent:(NSString *)parent
                               projectID:(NSString *)projectID
                                   block:(CompletionBlock)completionBlock;

#pragma mark - 2.创建文件夹
- (void)requestCloudAddFolderWithParent:(NSString *)parent
                              projectID:(NSString *)projectID
                                   name:(NSString *)name
                                  block:(CompletionBlock)completionBlock;

#pragma mark - 3.添加文件
- (void)requestCloudAddFileWithParent:(NSString *)parent
                            projectID:(NSString *)projectID
                                 name:(NSString *)name
                                 size:(NSString *)size
                                 uuid:(NSString *)uuid
...
- (void)requestCloudDeleteWithCloudID:(NSString *)cloudID
                            projectID:(NSString *)projectID
                     folderOrFileType:(NSNumber *)folderOrFileType
                                block:(CompletionBlock)completionBlock;

#pragma mark - 5.重命名
- (void)requestCloudRenameWithCloudID:(NSString *)cloudID
                            projectID:(NSString *)projectID
                                 name:(NSString *)name
                     folderOrFileType:(NSNumber *)folderOrFileType
                                block:(CompletionBlock)completionBlock;
...
#pragma mark - 6.共享
- (void)requestCloudShareWithCloudID:(NSString *)cloudID
                           projectID:(NSString *)projectID
                               users:(NSArray *)users
                           hasShared:(BOOL)hasShared
                               block:(CompletionBlock)completionBlock;

#pragma mark - 7.移动
- (void)requestCloudMoveWithCloudID:(NSString *)cloudID
                          projectID:(NSString *)projectID
                  destinationParent:(NSString *)destinationParent
                   folderOrFileType:(NSNumber *)folderOrFileType
                              block:(CompletionBlock)completionBlock;

#pragma mark - 8.上传版本 问题
- (void)requestCloudAddVersionWithCloudID:(NSString *)cloudID
                                projectID:(NSString *)projectID
                                     uuid:(NSString *)uuid
                                     size:(NSString *)size
                                    block:(CompletionBlock)completionBlock;
...
- (void)requestCloudSharedListWithCloudID:(NSString *)cloudID
                                projectID:(NSString *)projectID
                                    block:(CompletionBlock)completionBlock;

#pragma mark - 10.获取文件版本 问题
- (void)requestCloudListVersionWithCloudID:(NSString *)cloudID
                                 projectID:(NSString *)projectID
                                     block:(CompletionBlock)completionBlock;


#pragma mark - 11.网盘文件下载
- (void)requestCloudDownloadWithProjectID:(NSString *)projectID
                                  cloudID:(NSString *)cloudID
                                     uuid:(NSString *)uuid
                                    block:(CompletionBlock)completionBlock;
...
#pragma mark - 12.获取日志
- (void)requestCloudGetLogWithProjectID:(NSString *)projectID
...
- (void)requestCloudGetTrashWithProjectID:(NSString *)projectID
                                    count:(NSString *)count
                                   before:(NSString *)before
                                    after:(NSString *)after
                                    block:(CompletionBlock)completionBlock;
...
- (void)requestCloudClearTrashWithProjectID:(NSString *)projectID
                                      block:(CompletionBlock)completionBlock;

#pragma mark - 15.恢复
- (void)requestCloudRecoverFileWithProjectID:(NSString *)projectID
                                     cloudID:(NSString *)cloudID
                                        name:(NSString *)name
                                  destParent:(NSString *)destParent
                                       block:(CompletionBlock)completionBlock;

#pragma mark - 17.检索文件
- (void)requestCloudSearchFileWithProjectID:(NSString *)projectID
                                    cloudID:(NSString *)cloudID
                                       page:(NSString *)page
                                      count:(NSString *)count
                                       name:(NSString *)name
